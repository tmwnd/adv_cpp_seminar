...
% \begin{frame}{Aufteilung der Themen}
%     \begin{itemize}
%         \item 00:00 - 02:00 Einleitung (Felix)
%         \item 02:00 - 04:30 Vorwissen (Tim)
%         \item 04:30 - 12:30 Motivation

%               \begin{itemize}
%                   \item Schlechte Fehlermeldungen (Felix)
%                   \item Unübersichtlicher Code (Tim)
%                   \item (Compiler-) Geschwindigkeitsoptimierung (Tim)
%               \end{itemize}
%         \item 12:30 - 20:30 Anwendung -> std::

%               \begin{itemize}
%                   \item Constrained Algorithms (Tim)
%                   \item Projection (Tim)
%                   \item Range Concepts (Felix)
%                   \item - 20:30 - Views (Felix)
%                   \item Beispiel Views (Tim)
%                   \item Eigene View (Felix)
%               \end{itemize}
%         \item 45:00 - **:** Aufgaben (Tim)
%     \end{itemize}
% \end{frame}
...
\begin{frame}
    ...
    \tableofcontents
\end{frame}
\input{sections/impl_alt.tex}

% vorwissen (5 min)
\section{Vorwissen}
\input{sections/iterators.tex}
\input{sections/concepts.tex}

% einleitung (10 min)
\section{Motivation}
\input{sections/error_msg.tex}
\input{sections/code_ovw.tex}
\input{sections/comp_speed.tex}

% anwendung (35 min)
\section{Anwendung}
\input{sections/constrained_algorithms.tex}
\input{sections/projection.tex}
\input{sections/ranges_types.tex}
\input{sections/views.tex}
% \input{sections/pipes.tex}
