...
\webaddress{https://www.github.com/tmwnd/adv_cpp_seminar} % overrides www.rwth-aachen.de
\date{\today}
\subject{Advanced C++}
...
\logo{\vskip+1mm\includegraphics[width=14mm]{logos/logo.pdf}\hspace{+1mm}} % optionally
